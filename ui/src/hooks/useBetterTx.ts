...
interface TransactionChain {
  ...
  onSuccess: (
    callback: (
      result: SuiTransactionBlockResponse | CreateSponsoredTransactionApiResponse | undefined,
    ) => void | Promise<void>,
  ) => TransactionChain;
...
export function useBetterSignAndExecuteTransaction<TArgs extends unknown[] = unknown[]>({
  ...
  const handleSignAndExecuteTransaction = (...args: TArgs): TransactionChain => {
    ...
    let successCallback:
      | ((result: SuiTransactionBlockResponse | undefined) => void | Promise<void>)
      | undefined;
...
export function useBetterSignAndExecuteTransactionWithSponsor<TArgs extends unknown[] = unknown[]>(
  ...
  const handleSignAndExecuteTransactionWithSponsor = (
    ...
    let successCallback:
      | ((result: CreateSponsoredTransactionApiResponse) => void | Promise<void>)
      | undefined;
    let errorCallback: ((error: Error) => void) | undefined;
    let settledCallback:
      | ((result: CreateSponsoredTransactionApiResponse | undefined) => void | Promise<void>)
      | undefined;
    let beforeExecuteCallback: (() => Promise<boolean | void>) | undefined;
