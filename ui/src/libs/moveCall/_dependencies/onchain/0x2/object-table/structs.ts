  ...
  implements StructClass
{
  ...
  readonly $fullTypeName: `${typeof PKG_V28}::object_table::ObjectTable<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  private constructor(
    ...
    this.$fullTypeName = composeSuiType(
      ...
      ...typeArgs,
    ) as `${typeof PKG_V28}::object_table::ObjectTable<${PhantomToTypeStr<T0>}, ${PhantomToTypeStr<T1>}>`;
  ...
  >(T0: T0, T1: T1): ObjectTableReified<ToPhantomTypeArgument<T0>, ToPhantomTypeArgument<T1>> {
    return {
      ...
      ) as `${typeof PKG_V28}::object_table::ObjectTable<${PhantomToTypeStr<ToPhantomTypeArgument<T0>>}, ${PhantomToTypeStr<ToPhantomTypeArgument<T1>>}>`,
