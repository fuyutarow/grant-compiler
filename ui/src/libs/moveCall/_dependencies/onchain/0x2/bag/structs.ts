...
export class Bag implements StructClass {
  ...
  static readonly $typeName = `${PKG_V28}::bag::Bag`;
  ...
  static reified(): BagReified {
    return {
      ...
      fullTypeName: composeSuiType(Bag.$typeName, ...[]) as `${typeof PKG_V28}::bag::Bag`,
      typeArgs: [] as [],
