...
export class Extension implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ExtensionFields, ) { this.$fullTypeName = composeSuiType( Extension.$typeName, ...typeArgs ) as `${typeof PKG_V28}::kiosk_extension::Extension`; this.$typeArgs = typeArgs;
