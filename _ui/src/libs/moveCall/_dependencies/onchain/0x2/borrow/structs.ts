...
export class Borrow implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: BorrowFields, ) { this.$fullTypeName = composeSuiType( Borrow.$typeName, ...typeArgs ) as `${typeof PKG_V28}::borrow::Borrow`; this.$typeArgs = typeArgs;
